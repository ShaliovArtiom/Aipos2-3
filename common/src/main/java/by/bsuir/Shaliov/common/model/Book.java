...
public class Book implements org.apache.thrift.TBase<Book, Book._Fields>, java.io.Serializable, Cloneable, Comparable<Book> {
  ...
  public javafx.beans.property.StringProperty getBookNameProperty() {
    javafx.beans.property.StringProperty bookNameProperty = new javafx.beans.property.SimpleStringProperty(bookName);
        return bookNameProperty;
    }

  public javafx.beans.property.StringProperty getAuthorNameProperty() {
    javafx.beans.property.StringProperty authorNameProperty = new javafx.beans.property.SimpleStringProperty(authorName);
